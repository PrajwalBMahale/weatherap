...
const Details2 = ({  route }: any) => {
    ...
    return (
        ...
        <Image style={{width: 125,height: 125,marginTop:150,marginLeft:15, alignSelf: "center"}} 
        source={{ uri: countryDetail?.current.weather_icons[0] }} />

        <Text style={{fontSize:20,padding:15, alignSelf: "center"}}>Temperature : {countryDetail?.current.temperature}°C</Text>

        <Text style={{fontSize:20,padding:15, alignSelf: "center"}}>Precipitation : {countryDetail?.current.precip}%</Text>

        <Text style={{fontSize:20,padding:15, alignSelf: "center"}}>Wind Speed : {countryDetail?.current.wind_speed} kmph</Text>
